...
const Profile = () => {
  ...
  return (
    <div className=''>
      {editingReminder && editANameOnly && <CartNav />}

      {editingReminder && editANameOnly &&
      ...
      {editingReminder && editANameOnly
        ...
        <div className='max-w-[1208px] mx-auto mt-8 lg:block hidden'>
          <div className='flex justify-between bg-white drop-shadow-xl rounded-xl xl:mx-0 mx-2'>
            ...
            <div className='flex'><SearchByName /></div>
          </div>
        </div>
      }
      ...
      {editingReminder && editANameOnly && activeIndex === 0 &&
        <>
      ...
      {editingReminder && editANameOnly && activeIndex === 1 &&
        <>
          <div className="mt-8 flex">
            <div className='max-w-[1208px] m-auto flex w-full items-center capitalize font-bold text-[#4D6472] md:px-8 px-2'>
              <div className={`block-1 py-2 ${block1ForActiveIndex0} text-center`}>name</div>
      ...
      {!editingReminder
        && <div className='fixed top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] md:w-[547px] md:h-[423px] w-[347px] h-[423px] border rounded-3xl'>
      ...
      {!editANameOnly &&
        <div>
          <div className='fixed top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] md:w-[547px] md:h-[230px] w-[347px] h-[230px] border rounded-3xl'>
