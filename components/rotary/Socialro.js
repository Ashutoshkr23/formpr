  ...
  return (
    <div className='grid grid-cols-3 gap-y-11 mt-8 '>
        ...
        <div>
            ...
            <Image src="/whatsap.png" alt="WhatsApp Logo" width={55} height={55} />
            </Link>
        ...
        <div>
            ...
            <Image src="/gmailro.png" alt="gmail Logo" width={55} height={55} />
            </Link>
        ...
        <div>
            ...
            <Image src="/linkedin.png" alt="linkedin Logo" width={55} height={55} />
            </Link>
        ...
        <div className='instagram-icon'>
            ...
            <Image src="/instagram.png" alt="instagram Logo" width={55} height={55} />
            </Link>
        ...
        <div>
            ...
            <Image src="/facebook.png" alt="facebookLogo" width={55} height={55} />
            </Link>
            <p className='text-[12px]'>Facebook</p>
        </div>
          <div onClick={handleDownloadPdf}>
            <Image src="/pdf.png" alt="pdf Logo" width={55} height={55} />
