    ...
    <div className='mt-[296px] sm:px-8 md:px-16 lg:px-4 xl:px-0 max-w-[1208px] mx-auto'>
      ...
      <div className='relative hidden lg:block mx-auto max-w-[1212px] h-[428px] bg-[#090909] rounded-[20px] '>
        ...
        <div className='pt-8 pl-[424px] pr-[120px] xl:pr-[225px] text-[20px]'>
          <p className=' font-bold'><span className='text-transparent bg-gradient-to-br from-[#FDFF96] to-[#F16869] bg-clip-text xl:leading-[186%]'>At Loop, we&apos;re passionate about making networking effortless </span><span className='text-transparent bg-gradient-to-tr from-[#FDFF96] to-[#F16869] bg-clip-text'>and eco-friendly.  </span></p>
        </div>
