        ...
        <div className='bg-whitebg md:hidden'>
            <div className=' w-80 mobile:w-full  max-w-[360px] md:max-w-[740px] lg:w-full lg:max-w-[1100px] xl:max-w-[1230px] justify-between mx-auto flex items-center'>
                ...
                <div className='w-[280px] mobile:w-80 md:w-[700px] lg:min-w-full lg:max-w-[1020] xl:max-w-[1230px] xl:w-full h-32 overflow-hidden '>
                    ...
                    >
                        <div className=' w-[100%] h-full text-black flex justify-center'>
                            <div className='text-1 text-xs lg:text-base font-medium lg:font-bold px-4  flex items-center'>
                        ...
                        <div className=' w-[100%] h-full text-black flex justify-center'>
                            <div className="text-2 max-w-[387px] text-xs lg:text-base font-medium lg:font-bold px-4  flex items-center">
                        ...
                        <div className=' w-[100%] h-full text-black flex justify-center '>
                            <div className="text-3 text-xs lg:text-base font-medium lg:font-bold px-4  flex items-center">
