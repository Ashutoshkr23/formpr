  ...
  return (
    <div className='mt-20'>
      <div className='w-80 mobile:w-full max-w-[380px] md:max-w-[740px] lg:w-full lg:max-w-[1100px] xl:max-w-[1230px] justify-between mx-auto flex items-center'>
        ...
        <div className='w-[280px] mobile:w-80 md:w-[700px] lg:min-w-[984px] lg:max-w-[1020] xl:max-w-[1230px] xl:w-full h-60 overflow-hidden '>
          <div
            className='w-[840px] mobile:w-[960px] md:w-[1050px] lg:min-w-[984px] lg:w-full lg:max-w-[1020] xl:max-w-[1230px] xl:w-full h-60 flex'
            style={{
              transform: `translateX(${-currentIndex * (100 / numDivs)}%)`,
              transition: 'transform 0.3s ease-in-out',
            }}
          >
            <div className='w-[100%] h-60 bg-slate-200 flex justify-center'></div>
            <div className='w-[100%] h-60 bg-slate-500 flex justify-center'></div>
            <div className='w-[100%] h-60 bg-slate-800 flex justify-center'></div>
          </div>
        </div>
