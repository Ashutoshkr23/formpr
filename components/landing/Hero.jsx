  ...
  return (
    <div className="flex lg:flex-row justify-between items-center max-w-[1208px] mx-auto flex-col  lg:mt-16 lg:px-4 lg:pb-  xl:px-0">
      <div className="flex flex-col items-center lg:items-start mt-12  lg:mt-0  px-2  mobile:px-4 md:px-0 mx-auto lg:mx-0 max-w-[456px] xl:max-w-[680px] ">
        ...
        >
          Welcome to The Loop, a community of high-networking individuals
          connected through the next generation of NFC-enabled digital visiting
          cards.
        </motion.h3>
        <motion.button
          initial={{ opacity: 0 }}
        ...
        <div className="hidden md:block">
          ...
          >
            <div className="bg-white w-[215px] items-center flex rounded-2xl h-[74px] drop-shadow-white">
              <Image
                src="/assets/images/landing/Eco-Friendly.png"
                alt=""
                height={50}
                width={50}
                className=" mx-6"
            ...
            <div className="bg-white w-[215px] items-center flex rounded-2xl h-[74px] drop-shadow-white">
              <Image
                src="/assets/images/landing/NFC.png"
                alt=""
                height={50}
                width={50}
                className=" mx-6"
            ...
            <div className="bg-white w-[215px] items-center flex  rounded-2xl h-[74px] drop-shadow-white">
              <Image
                src="/assets/images/landing/QR-code.png"
                alt=""
                height={50}
                width={50}
                className=" mx-6"
            ...
            <div className="bg-white w-[215px] items-center flex rounded-2xl h-[74px] drop-shadow-white">
              <Image
                src="/assets/images/landing/Infinite-Symbol.png"
                alt=""
                height={50}
                width={50}
                className=" mx-6"
            ...
            <div className="bg-white w-[215px] items-center flex rounded-2xl h-[74px] drop-shadow-white">
              <Image
                src="/assets/images/landing/Alarm.png"
                alt=""
                height={50}
                width={50}
                className=" mx-6"
            ...
            <div className="bg-white w-[215px] items-center flex rounded-2xl h-[74px] drop-shadow-white">
              <Image
                src="/assets/images/landing/Pocket.png"
                alt=""
                height={50}
                width={50}
                className=" mx-6"
          ...
          >
            ...
            <div className="bg-white w-[150px] items-center flex  rounded-2xl h-[60px] drop-shadow-white">
              <Image
                ...
                className=" mx-2"
              />
              <p className="text-xs font-bold pr-2 -tracking-[0.5px]">
                QR code-enabled
              </p>
            </div>
            <div className="bg-white w-[150px] items-center flex rounded-2xl h-[60px] drop-shadow-white">
      ...
      <motion.div
        className=" hidden md:block mx-auto lg:ml-auto lg:mx-0 lg:pr-32"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className=" relative h-[580px] w-[260px]  ">
          ...
          >
            <Image
              src={"/assets/images/landing/LoopCard1.png"}
              width={220}
              height={169}
              alt="sample nfc visting card"
              quality={100}
            />
          </motion.div>
          <motion.div
          ...
          >
            <Image
              ...
              src={"/assets/images/landing/landingProfileTop.png"}
              width={260}
              height={560}
              quality={100}
          ...
          >
            <Image
              src={"/assets/images/landing/phone2.png"}
              width={260}
              height={154}
          ...
          >
            <Image
              src={"/assets/images/landing/CardDark.png"}
              width={244}
              height={177}
              alt="sample nfc visting card"
              quality={100}
