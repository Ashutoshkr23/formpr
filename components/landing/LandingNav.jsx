          ...
          <div className=" mx-auto   my-auto h-20 flex content-center justify-between items-center">
            ...
            <div className="flex content-center">
              <ul className="flex content-center gap-8 my-auto ">
                <li className=" text-sm w-[61px]  text-center hover:font-bold ">
                  <a href={`#product`}>Products</a>
                </li>
                <li className=" text-sm w-[70px]  text-center hover:font-bold ">
                  <a href="#story">Our Story</a>
                </li>
                <li className=" text-sm  w-[70px]  text-center hover:font-bold ">
                  <a href="#partners">Partners</a>
                </li>
                <li className=" text-sm w-[30px]  text-center hover:font-bold ">
                  <a href="#faq">FAQ</a>
                </li>
                <li className=" text-sm  w-[53px]  text-center hover:font-bold  ">
