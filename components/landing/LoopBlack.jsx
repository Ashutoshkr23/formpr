        ...
        <div className='lg:mt-[222px] mt-[131px] '>
                ...
                <div className='  pt-16 lg:pl-4 xl:pl-9 flex '>
                    ...
                    <div className=' pr-5  flex flex-col items-center'>
                        <div className='hidden xl:block'>
                            <Image src={'/assets/images/landing/LoopBlack.png'} height={450} width={494} alt='loopcard' />
                        </div>
                        <div className='xl:hidden'>
                            <Image src={'/assets/images/landing/LoopBlack.png'} height={400} width={400} alt='loopcard' />
                        </div>
            ...
            <div className='lg:hidden h-[875px] max-w-[345px] md:max-w-[550px] md:flex md:flex-col items-center bg-black mx-auto rounded-[15px]'>
                <div className='pt-11 pl-[26px] '>
                    <div className='pl-2'>
                        <Image src={'/assets/images/landing/loopcard.png'} height={269} width={295} alt='loopcard' />
                    </div>
