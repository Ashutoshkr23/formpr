...
const ShippingComp = ({ address, setAddress, submitPressed }) => {
  ...
  return (
    <div className="w-full h-full ml-1 mr-4 text-white">
        ...
        <div className="flex md:flex-row flex-col gap-4 md:gap-0 w-full justify-between items-center mt-6">
          <div className="w-full ">
            <div className=" lg:w-full flex flex-col md:pr-4 pr-0">
              ...
              <input
                type="email"
                className="outline-none bg-white border text-black rounded-md border-zinc-500 h-9 px-2 text-sm "
                value={address.email}
                onChange={(e) => {
          ...
          <div className="w-full flex flex-col">
            <label className="text-sm pb-1 text-white">Phone number</label>
            <input
              type="text"
              className="outline-none  bg-white border rounded-md text-black border-zinc-500 h-9 px-2 text-sm"
      ...
      <div className="h-full mb-10 w-full rounded-lg shadow drop-shadow-2xl bg-[#000000] p-6 pb-10 mt-4">
        <p className="text-sm font-bold leading-snug uppercase mt-1">
          SHIPPING ADDRESS
        </p>
        <div className="flex md:flex-row gap-2 md:gap-0 flex-col w-full justify-between items-center mt-8">
          ...
          <div className="w-full flex flex-col">
            <label className="text-sm pb-1 text-white">Last name</label>
            <input
              type="text"
        ...
        <div className="flex w-full justify-between items-center mt-5">
          <div className="w-full flex flex-col">
            <label className="text-sm pb-1 text-white">Address</label>
            <input
              type="text"
              className="outline-none bg-white border rounded-md border-zinc-500 text-black h-9 px-2 text-sm"
        ...
        <div className="flex md:flex-row flex-col gap-4 md:gap-0 w-full justify-between items-center mt-5">
          ...
          <div className="w-full flex flex-col">
            <label className="text-sm pb-1 text-white">State</label>
            <input
              type="text"
              className="outline-none bg-white border rounded-md border-zinc-500 text-black h-9 px-2 text-sm"
              value={address.state}
