              ...
              <div className="flex flex-col gap-6 mt-4 lg:mt-0  lg:items-stretch">
                ...
                <div className="flex justify-between ">
                  ...
                  <div className="flex gap-1 items-center">
                    ...
                    ></div>
                    <div
                      className={`rounded-full cursor-pointer bg-[#000000] w-3 h-3 lg:w-5 lg:h-5 ${
                        font === "black"
            ...
            <div>
              <div className="flex mt-4">
                {card.fileName ? ( // Display the file name if it exists
                  ...
                  <label
                    htmlFor="fileInput"
                    className={`cursor-pointer py-2 flex justify-between border text-xs sm:text-sm lg:text-base  ${
                      checkFormValid &&
