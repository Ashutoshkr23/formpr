          ...
          <div className="flex items-center gap-10  xl:gap-20 mt-10 flex-col-reverse justify-center lg:flex-row ">
            <div className="">
              <div className="flex flex-row lg:flex-col  justify-between gap-6 ">
                <div>
                  <div className=" pr-2 mb-7 lg:mb-2 bg-white h-9 lg:h-12 max-w-[170px] lg:w-[190px] pl-4   rounded-[10px] drop-shadow-lg">
                    <div
                ...
                <div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <button className="h-9 mt-7 px-2 lg:mt-4 w-[145px] lg:h-[41px] lg:w-[164px]  rounded-[10px]  bg-white text-black outline-none border text-[10px] lg:text-xs font-bold">
