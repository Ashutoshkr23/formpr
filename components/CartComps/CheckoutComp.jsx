            ...
            <div className=" lg:w-3/5  flex  flex-wrap space-x-2  lg:justify-between   ">
                <div className="container mx-auto mb-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="relative grid grid-cols-2 gap-1 bg-white rounded-xl cursor-pointer shadow-xl ring-offset-1  ring-offset-transparent ring-[#001926] p-4 h-[250px]">
                            <div>
                            ...
                            <div className="absolute top-[-12px] right-0 rounded-md flex  items-center justify-end w-[100px] px-1 pt-0.5 bg-black">
                                <p className="text-xs font-bold leading-tight text-center text-white">REMOVE</p>
                                <p className="text-base font-medium leading-7 text-center text-white pl-2">X</p>
                            </div>
                            <div className='px-1 py-2'>
                                <p className="text-sm font-bold leading-7">Loop Lite</p>
                            ...
                            <div>
                                <p className="text-xs mb-3 font-medium">Full Name <br /><span className='font-semibold text-sm'>Manpreet Worlikar</span></p>
                                <p className="text-xs font-medium">Company Name <br /><span className='font-semibold text-sm'>Alphamint Labs</span></p>
                            </div>
                            <div>
            ...
            <div className="hidden lg:block  pl-2">
                <div className="w-full  lg:w-[300px] xl:w-[385px] shadow-xl min-h-[510px] bg-white rounded-xl py-8">
                    ...
                    <div className='mx-5 my-6'>
                        <div className="flex items-center justify-between w-full h-10 px-5 bg-black border rounded-lg border-black">
