            ...
            {cardsArray.length &&
              cardsArray.map((data) => {
                return (
                  <div
                    key={data.key}
                    className="relative grid grid-cols-2 gap-1 bg-white rounded-xl cursor-pointer shadow-xl ring-offset-1  ring-offset-transparent ring-[#001926] p-4 h-[250px]"
                  >
                    <div>
                      <Image
                        src={"/assets/images/checkoutImages/johnCard.png"}
                        height={250}
                        width={300}
                        alt="demo"
                        quality={100}
                      ...
                      {data.companyLogo && data.companyLogo.length ? (
                        <div>
                          <img
                            ...
                            className=" object-fill w-[140px] h-[75px] "
                          />
                        </div>
                      ) : (
                        <div className="w-36 h-20 bg-slate-200 rounded-md mt-1"></div>
                      )}
                    </div>
                  </div>
                );
